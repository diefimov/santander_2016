...
def main():
        ...
        SEED=15
        outset="et_marios_1_2" # predic of all files
        ...
        model=ExtraTreesClassifier(n_estimators=30000,criterion='entropy',max_depth=15,min_samples_leaf=1,max_features=1.0,
