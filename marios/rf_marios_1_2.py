...
def main():
        ...
        SEED=15
        outset="rf_marios_1_2" # predic of all files
        ...
        model=RandomForestClassifier(n_estimators=30000,criterion='entropy',max_depth=10,min_samples_leaf=5,max_features=0.25,
                                     bootstrap=False,n_jobs=25,random_state=1)
        ...
        preds=bagged_set(X, y,model, SEED, 2, X_test, update_seed=True) 
