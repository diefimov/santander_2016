...
def main():
        ...
        SEED=15
        outset="xgboost_marios_1_2" # predic of all files
        ...
        model=xg.XGBoostClassifier(num_round=1000000 ,nthread=62,  eta=0.00001, gamma=0.1,max_depth=5, min_child_weight=1, subsample=0.9, 
