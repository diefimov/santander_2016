...
def main():
        ...
        SEED=15
        outset="xgboost_marios_1" # predic of all files
        ...
        model=xg.XGBoostClassifier(num_round=1000 ,nthread=30,  eta=0.01, gamma=0.1,max_depth=5, min_child_weight=1, subsample=0.9, 
                                   colsample_bytree=0.45,objective='binary:logistic',num_parallel_tree=1, seed=1)        
