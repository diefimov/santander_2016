...
def main():
        ...
        SEED=15
        outset="ada_marios_7_3" # predic of all files
        ...
        for kfolder in kfolders:
            ...
            if number_of_folds>0:
                for train_index, test_index in kfolder:
                    ...
                    modela=ExtraTreesClassifier(n_estimators=300,criterion='entropy',max_depth=14,min_samples_leaf=4,max_features=1.0,
                                     bootstrap=False,n_jobs=60,random_state=1)
        ...
        modela=ExtraTreesClassifier(n_estimators=300,criterion='entropy',max_depth=14,min_samples_leaf=4,max_features=1.00,
                         bootstrap=False,n_jobs=60,random_state=1)
